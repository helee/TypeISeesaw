...
V_154 = Vertex(name = 'V_154',
              particles = [ P.Nm, P.vm, P.H ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_109})

V_155 = Vertex(name = 'V_155',
              particles = [ P.vm__tilde__, P.Nm, P.H ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_109})
...
V_156 = Vertex(name = 'V_156',
              particles = [ P.mu__plus__, P.Nm, P.W__minus__ ],
              color = [ '1' ],
              lorentz = [ L.FFV2 ],
              couplings = {(0,0):C.GC_110})

V_157 = Vertex(name = 'V_157',
               particles = [ P.Nm, P.mu__minus__, P.W__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_110})
...
V_158 = Vertex(name = 'V_158',
              particles = [ P.Nm, P.vm, P.Z ],
              color = [ '1' ],
              lorentz = [ L.FFV2 ],
              couplings = {(0,0):C.GC_111})

V_159 = Vertex(name = 'V_159',
              particles = [ P.vm__tilde__, P.Nm, P.Z ],
              color = [ '1' ],
              lorentz = [ L.FFV2 ],
              couplings = {(0,0):C.GC_111})
...
V_161 = Vertex(name = 'V_161',
              particles = [ P.Nm, P.ve, P.H ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_109})

V_162 = Vertex(name = 'V_162',
              particles = [ P.ve__tilde__, P.Nm, P.H ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_109})

V_163 = Vertex(name = 'V_163',
              particles = [P.e__plus__, P.Nm, P.W__minus__ ],
              color = [ '1' ],
              lorentz = [ L.FFV2 ],
              couplings = {(0,0):C.GC_110})

V_164 = Vertex(name = 'V_164',
              particles = [P.Nm, P.e__minus__, P.W__plus__ ],
              color = [ '1' ],
              lorentz = [ L.FFV2 ],
              couplings = {(0,0):C.GC_110}) 

V_165 = Vertex(name = 'V_165',
              particles = [P.Nm, P.ve, P.Z],
              color = [ '1' ],
              lorentz = [ L.FFV2 ],
              couplings = {(0,0):C.GC_111})

V_166 = Vertex(name = 'V_166',
              particles = [ P.ve__tilde__, P.Nm, P.Z ],
              color = [ '1' ],
              lorentz = [ L.FFV2 ],
              couplings = {(0,0):C.GC_111})
