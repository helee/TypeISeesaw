...
GC_109 = Coupling(name = 'GC_109',
                 value = '-((complex(0,1)*yN)/cmath.sqrt(2))',
                 order = {'QED':1})

GC_110 = Coupling(name = 'GC_110',
                 value = '(ee*VmuN*complex(0,1))/(sw*cmath.sqrt(2))',
                 order = {'QED':1})

GC_111 = Coupling(name = 'GC_111',
                 value = '(cw*ee*VmuN*complex(0,1))/(2.*sw) + (ee*VmuN*complex(0,1)*sw)/(2.*cw)',
                 order = {'QED':1})

GC_112 = Coupling(name = 'GC_112',
                 value = '(cw*ee*VmuN**2*complex(0,1))/(2.*sw) + (ee*VmuN**2*complex(0,1)*sw)/(2.*cw)',
                 order = {'QED':1})
